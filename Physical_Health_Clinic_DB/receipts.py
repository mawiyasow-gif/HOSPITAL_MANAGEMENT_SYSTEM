...
class ReceiptWindow(ctk.CTkToplevel):
    ...
    def _create_pdf_receipt(self, file_path):
        ...
        receipt_para = Paragraph(f"<b>Receipt No:</b> {receipt_id}", receipt_style)
        ...
        receipt_data = [
            ...
            ["Amount Paid:", f"Le {data['Amount']:,.2f}"],
        ]
        ...
        footer = Paragraph("Thank You For Choosing Our Clinic", footer_style)
        story.append(footer)
